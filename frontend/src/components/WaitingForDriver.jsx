    ...
    <div>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='text-right'>
          <h2 className='text-lg font-medium capitalize'>fghj</h2>
          <h4 className='text-xl font-semibold -mt-1 -mb-1'>fghjkm,</h4>
        ...
        <div className='w-full mt-5'>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              ...
              <p className='text-sm -mt-1 text-gray-600'>Dholakpur</p>
            </div>
          </div>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              <h3 className='text-lg font-medium'>562/11-A</h3>
              <p className='text-sm -mt-1 text-gray-600'>Furfurinagar</p>
            </div>
          </div>
